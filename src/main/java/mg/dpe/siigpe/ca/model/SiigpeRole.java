...
public class SiigpeRole implements Serializable {
    ...
    @ManyToMany(mappedBy = "siigpeRoleList")
    @JsonBackReference
    private List<SiigpeUser> siigpeUsersList;
    ...
    public List<SiigpeUser> getSiigpeUsersList() {
        return siigpeUsersList;
    }

    public void setSiigpeUsersList(List<SiigpeUser> siigpeUsersList) {
        this.siigpeUsersList = siigpeUsersList;
    }
